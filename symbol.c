...
/*
 * print to file symbol name and symbol address
 */
void print_base_required(FILE *dest, symbol to_print) {
    unsigned long base_required_size,address,i;
...
/*
 * print to file symbol offset
 */
void print_offset_required(FILE *dest, symbol to_print) {
    unsigned long offset_required_size, address, i;
