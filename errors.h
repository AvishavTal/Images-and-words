...
typedef enum {NOT_ERROR,UNDEFINED_OPERATOR,ILLEGAL_SYMBOL_NAME,
              ...
              TOO_MANY_CHARS,ILLEGAL_DATA,ILLEGAL_STRING,SYNTAX_ERROR,INVALID_REGISTER_FOR_INDEX,ILLEGAL_OPERAND,
              ILLEGAL_STRING_SYNTAX,DOUBLE_DEFINITION_OF_SYMBOL,ILLEGAL_COMMA,MISSING_COMMA,TOO_LONG_LINE,MEMORY_OVERFLOW,SAME_SYMBOL_FOR_ENTRY_AND_EXTERN}error;
