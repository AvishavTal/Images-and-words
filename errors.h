...
typedef enum {NOT_ERROR,UNDEFINED_OPERATOR,ILLEGAL_SYMBOL_NAME,
              TOO_MANY_ARGS,TOO_FEW_ARGS,ILLEGAL_ADDRESSING,INVALID_REGISTER_NAME,NOT_INT,UNDEFINED_SYMBOL,ILLEGAL_DATA,ILLEGAL_STRING,INVALID_REGISTER_FOR_INDEX,ILLEGAL_OPERAND,STRING_NOT_EXIST,
              ILLEGAL_STRING_SYNTAX,DOUBLE_DEFINITION_OF_SYMBOL,ILLEGAL_COMMA,MISSING_COMMA,TOO_LONG_LINE,MEMORY_OVERFLOW,BOTH_ENTRY_AND_EXTERN_FOR_SAME_SYMBOL,DATA_NOT_EXIST}error;
