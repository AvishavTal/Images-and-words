...
//void add_symbol(symbol_table table,char *name,long address,long base_address,long offset,
...
//        symbol new_symbol;
//        new_symbol= init_symbol_with_values(name,address,base_address,offset,is_entry,is_extern,is_data,is_code);
