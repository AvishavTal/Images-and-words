...
/*
 * this function gets legal symbol name and push it to the table
 */
void push_symbol(symbol_table to_update, symbol to_push) {
    add_to_tail(to_update->table,to_push);
}

/* this function gets symbol table, name of symbol, flag if this symbol is extern and option to error
...
/* this function gets name of symbol
